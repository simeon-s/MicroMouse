...
//
//*****************************************************************************
extern float g_pfEulers[3];
extern float g_pfAccel[3];
extern volatile float g_pfGyro[3];
extern float g_pfGyroOffset[3];
extern float fAngle;
...
void MPU6050DataAccelGetFloat(SD_MPU6050 *psInst, float *pfAccelX, float *pfAccelY, float *pfAccelZ);
/**
 * @}
 */
